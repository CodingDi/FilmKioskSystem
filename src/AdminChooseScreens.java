 ...
 * Description: This class contains the definition of AdminChooseScreens
...
public class AdminChooseScreens {
		...
		public void actionPerformed(ActionEvent e)
		{
		 ...
		 private boolean checkStartTime(int lastTime, ArrayList<ArrayList<String>> stSched, 
				 ...
				 ArrayList<String> lastTimeList, ArrayList<String> screenFilmListTemp)
		    {
		    	...
		    	if(shour > maxH)
		    	{
		    		if( (smin + (shour - maxH - 1) * 60 + (60 - maxM)) > last + 15)
		    			return true;
		    		else
		    			return false;
		    	}
    ...
    {
        /**This method is to set up a frame to give customers a welcome frame
         * @param m    store the message
         * @param frame the base of the show up
         * @param
         *
         */
