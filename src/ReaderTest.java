...
public class ReaderTest {
    ...
    */ 
    /*---------------screen n_x.txt文件读取测试------------------------
    	//-------screen1 的测试--------
    	 ...
    	 System.out.println("screen 1_1 剩余票数: " + Screen1.ticketCount);*/
    	//------screen2 的测试---------
    /*	 rd.readScreen(2, 1, "KONG SKULL ISLAND");
    	 ...
    	 System.out.println("screen 2_1_KONG SKULL ISLAND 剩余票数: " + Screen2.ticketCount);*/
  ...
  /*      //-------screen3 的测试--------
        ...
        System.out.println("screen 3_1 剩余票数: " + Screen3.ticketCount);
     */
     /*--------------screen_schedule 文件读取测试------------------------*/
